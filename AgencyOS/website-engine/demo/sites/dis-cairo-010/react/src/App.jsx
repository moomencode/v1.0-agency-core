  ...
  <div className={"container"}>
    <nav className={"nav__inner"} aria-label={"Main navigation"}>
      <a className={"nav__brand"} href={"#home"}>
        <img src={"/logo/logo-light.png"} alt={"Nile Terrace Logo"} height={"36"} />
{"NILE"}
      </a>
...
{"(512+ Reviews)"}
              ...
              <div className={"hero__info-item"}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M7 20h10"/><path d="M7 16h10"/><path d="M6 16a4 4 0 0 1-1-7.8 6 6 0 0 1 11.7-1.3A4.5 4.5 0 0 1 18 16z"/></svg>
                <div>
                  <strong>
{"Chef Crafted"}
                  </strong>
...
{"Authentic recipes"}
          ...
          <div className={"hero__visual"}>
            <img src={"/hero/light-hero.jpg"} alt={"Nile Terrace Ambiance"} className={"img--cover"} />
          </div>
        </div>
      </div>
    </div>
...
{" (3)"}
    ...
    <div className={"menu__group"} id={"menu-starters"}>
      <h3>
{"Starters"}
      </h3>
      <div>
        <div className={"menu__dish"}>
          <img src={"/placeholders/image-1.svg"} alt={"Signature dishes"} className={"menu__dish-img"} />
...
{"60 EGP"}
        ...
        <div className={"menu__dish"}>
          <img src={"/placeholders/image-2.svg"} alt={"Set menus"} className={"menu__dish-img"} />
          <div className={"menu__dish-main"}>
            <span className={"menu__dish-name"}>
{"Set menus"}
            </span>
...
{"75 EGP"}
        ...
        <div className={"menu__dish"}>
          <img src={"/placeholders/image-3.svg"} alt={"Seasonal specials"} className={"menu__dish-img"} />
          <div className={"menu__dish-main"}>
            <span className={"menu__dish-name"}>
{"Seasonal specials"}
            </span>
...
{"90 EGP"}
    ...
    <div className={"menu__group"} id={"menu-mains"}>
      <h3>
{"Main Courses"}
      </h3>
      <div>
...
{"90 EGP"}
    ...
    <div className={"menu__group"} id={"menu-grills"}>
      <h3>
{"Grills"}
      </h3>
      <div>
...
{"90 EGP"}
    ...
    <div className={"menu__group"} id={"menu-desserts"}>
      <h3>
{"Desserts"}
      </h3>
      <div>
...
{"Reviews"}
      ...
      <div className={"stat"} id={"stat-dishes"}>
        <div className={"stat__value"}>
{"60+"}
        </div>
        <div className={"stat__label"}>
{"Signature Dishes"}
      ...
      <div className={"stat"} id={"stat-guests"}>
        <div className={"stat__value"}>
{"25000+"}
        </div>
        <div className={"stat__label"}>
...
{"Don't miss our offers"}
    ...
    <div className={"offers__grid"}>
      <div className={"offer"}>
        <img src={"/placeholders/image-1.svg"} alt={"Professional photo set (10+ images)"} className={"offer__img"} />
...
{"What our clients say"}
    ...
    <div className={"reviews__grid"}>
      <div className={"review"}>
        <span className={"review__stars"} role={"img"} aria-label={"5 out of 5 stars"}>
...
<section className={"sec sec--alt"} data-section={"location"} id={"location"} aria-label={"Location"}>
  <div className={"container"}>
    <div className={"sec__head"}>
      <span className={"sec__eyebrow"}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9z"/><path d="M19 15l.9 2.1L22 18l-2.1.9L19 21l-.9-2.1L16 18l2.1-.9z"/></svg>
...
{"Get Directions"}
      ...
      <a aria-label={"Open map in new tab"} rel={"noopener noreferrer"} target={"_blank"} href={"https://maps.google.com/?q=Cairo"}>
        <img src={"/backgrounds/map-dark.png"} alt={"Map to 1 Nile Corniche, Cairo"} className={"map-frame"} width={"600"} height={"320"} />
      </a>
    </div>
  </div>
</section>
...
{"Restaurant in Cairo"}
    ...
    <div className={"grid grid--3"}>
      <div className={"card--icon"}>
        ...
        <h3>
{"Strong business fundamentals (81/100)"}
        </h3>
        <p>
{"business score"}
        </p>
...
{"opportunity score"}
      ...
      <div className={"card--icon"}>
        ...
        <h3>
{"512 customer reviews build trust"}
        </h3>
        <p>
{"review count"}
        </p>
...
{"Monday - Sunday: 10:00 AM - 10:00 PM"}
        ...
        <div>
          <a className={"nav__link"} aria-label={"whatsapp"} rel={"noopener noreferrer"} target={"_blank"} href={"https://wa.me/201000000011"}>
{"whatsapp"}
          </a>
        </div>
      </div>
...
<section className={"sec"} data-section={"cta"} id={"cta"} aria-label={"Call to action"}>
  <div className={"cta"}>
    <div className={"container"}>
...
{"Order Now"}
          ...
          <a className={"btn btn--secondary"} href={"tel:+2027381111"}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 4h4l1.5 4L8 10a12 12 0 0 0 6 6l2-2.5 4 1.5v4a2 2 0 0 1-2.2 2A17 17 0 0 1 3 6.2 2 2 0 0 1 5 4z"/></svg>
{"Call Us"}
          </a>
        </div>
...
{"NILE"}
        ...
        <p>
{"Nile Terrace — Restaurant, serving Cairo."}
        </p>
      </div>
      <div>
...
{"+20 27 381 111"}
          ...
          <li>
            <a href={"mailto:hello@nileterrace.example"}>
{"hello@nileterrace.example"}
            </a>
          </li>
          <li>
{"1 Nile Corniche, Cairo"}
        ...
        <div className={"footer__links"}>
          <a aria-label={"whatsapp profile"} rel={"noopener noreferrer"} target={"_blank"} href={"https://wa.me/201000000011"}>
{"whatsapp"}
          </a>
        </div>
      </div>
...
{"Monday - Sunday: 10:00 AM - 10:00 PM"}
    ...
    <div className={"footer__bottom"}>
      <span>
{"© Nile Terrace All rights reserved."}
      </span>
      <span>
