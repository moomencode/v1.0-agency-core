  ...
  <div className={"container"}>
    <nav className={"nav__inner"} aria-label={"Main navigation"}>
      <a className={"nav__brand"} href={"#home"}>
        <img src={"/logo/logo-light.png"} alt={"Prime Properties Logo"} height={"36"} />
{"PRIME"}
      </a>
...
{"WhatsApp friendly"}
          ...
          <div className={"hero__visual"}>
            <img src={"/hero/light-hero.jpg"} alt={"Prime Properties Ambiance"} className={"img--cover"} />
          </div>
        </div>
      </div>
    </div>
...
{"The Prime Properties experience"}
      </h2>
    </div>
    <p className={"sec__sub"}>
{"Local Business in New Cairo"}
    </p>
    <div className={"grid grid--3"}>
      <div className={"card--icon"}>
        ...
        <h3>
{"Strong business fundamentals (74/100)"}
        </h3>
        <p>
{"business score"}
        </p>
...
{"opportunity score"}
      ...
      <div className={"card--icon"}>
        ...
        <h3>
{"64 customer reviews build trust"}
        </h3>
        <p>
{"review count"}
        </p>
...
{"Monday - Sunday: 10:00 AM - 10:00 PM"}
        ...
        <div>
          <a className={"nav__link"} aria-label={"whatsapp"} rel={"noopener noreferrer"} target={"_blank"} href={"https://wa.me/201000000013"}>
{"whatsapp"}
          </a>
        </div>
      </div>
...
{"Find us on the map"}
        ...
        <a aria-label={"Open map in new tab"} rel={"noopener noreferrer"} target={"_blank"} href={"https://maps.google.com/?q=New%20Cairo"}>
...
{"10:00 AM - 10:00 PM"}
        ...
        <a className={"btn btn--secondary"} href={"https://maps.google.com/?q=New%20Cairo"} rel={"noopener noreferrer"} target={"_blank"}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0z"/><circle cx="12" cy="10" r="3"/></svg>
{"Get Directions"}
        </a>
      </div>
      <a aria-label={"Open map in new tab"} rel={"noopener noreferrer"} target={"_blank"} href={"https://maps.google.com/?q=New%20Cairo"}>
        <img src={"/backgrounds/map-dark.png"} alt={"Map to 8 Fifth Settlement, New Cairo"} className={"map-frame"} width={"600"} height={"320"} />
      </a>
    </div>
  </div>
</section>
...
{"Book Now"}
          ...
          <a className={"btn btn--secondary"} href={"tel:+2022555666"}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 4h4l1.5 4L8 10a12 12 0 0 0 6 6l2-2.5 4 1.5v4a2 2 0 0 1-2.2 2A17 17 0 0 1 3 6.2 2 2 0 0 1 5 4z"/></svg>
{"Call Us"}
          </a>
        </div>
...
{"PRIME"}
        ...
        <p>
{"Prime Properties — Local Business, serving New Cairo."}
        </p>
      </div>
      <div>
...
{"+20 22 555 666"}
          ...
          <li>
            <a href={"mailto:sales@primeprops.example"}>
{"sales@primeprops.example"}
            </a>
          </li>
          <li>
{"8 Fifth Settlement, New Cairo"}
        ...
        <div className={"footer__links"}>
          <a aria-label={"whatsapp profile"} rel={"noopener noreferrer"} target={"_blank"} href={"https://wa.me/201000000013"}>
{"whatsapp"}
          </a>
        </div>
      </div>
...
{"Monday - Sunday: 10:00 AM - 10:00 PM"}
    ...
    <div className={"footer__bottom"}>
      <span>
{"© Prime Properties All rights reserved."}
      </span>
      <span>
