  ...
  <div className={"container"}>
    <nav className={"nav__inner"} aria-label={"Main navigation"}>
      <a className={"nav__brand"} href={"#home"}>
        <img src={"/logo/logo-light.png"} alt={"Atelier Cairo Logo"} height={"36"} />
{"ATELIER"}
      </a>
...
{"Location"}
        ...
        <div className={"nav__icon-row"}>
          ...
          <span className={"nav__cta"}>
            <a className={"btn btn--primary"} aria-label={"Get a Quote"} href={"#contact"}>
{"Get a Quote"}
            </a>
          </span>
        </div>
...
{"Tailor & Alterations Reach us today."}
            </p>
...
{"(91+ Reviews)"}
              ...
              <div className={"hero__info-item"}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M8.5 7.5L20 19M8.5 16.5L20 5"/></svg>
                <div>
                  <strong>
{"Hand Crafted"}
                  </strong>
...
{"Made to measure"}
          ...
          <div className={"hero__visual"}>
            <img src={"/hero/light-hero.jpg"} alt={"Atelier Cairo Ambiance"} className={"img--cover"} />
          </div>
        </div>
      </div>
    </div>
...
<section className={"sec sec--deep"} data-section={"stats"} id={"stats"} aria-label={"Statistics"}>
  <div className={"container"}>
...
{"Reviews"}
      ...
      <div className={"stat"} id={"stat-garments"}>
        <div className={"stat__value"}>
{"5000+"}
        </div>
        <div className={"stat__label"}>
...
{"Why Choose Us"}
      ...
      <h2 className={"sec__title"}>
{"The Atelier Cairo experience"}
      </h2>
    </div>
    <p className={"sec__sub"}>
{"Tailor & Alterations in Cairo"}
    </p>
    <div className={"grid grid--3"}>
      <div className={"card--icon"}>
        ...
        <h3>
{"Strong business fundamentals (66/100)"}
        </h3>
        <p>
{"business score"}
        </p>
...
{"opportunity score"}
      ...
      <div className={"card--icon"}>
        ...
        <h3>
{"91 customer reviews build trust"}
        </h3>
        <p>
{"review count"}
        </p>
...
{"Monday - Sunday: 10:00 AM - 10:00 PM"}
        ...
        <div>
          <a className={"nav__link"} aria-label={"whatsapp"} rel={"noopener noreferrer"} target={"_blank"} href={"https://wa.me/201000000015"}>
{"whatsapp"}
          </a>
        </div>
      </div>
...
{"Get Directions"}
      ...
      <a aria-label={"Open map in new tab"} rel={"noopener noreferrer"} target={"_blank"} href={"https://maps.google.com/?q=Cairo"}>
        <img src={"/backgrounds/map-dark.png"} alt={"Map to 3 Zamalek St, Cairo"} className={"map-frame"} width={"600"} height={"320"} />
      </a>
    </div>
  </div>
</section>
...
{"ATELIER"}
        ...
        <p>
{"Atelier Cairo — Tailor & Alterations, serving Cairo."}
        </p>
      </div>
      <div>
...
{"Contact Us"}
        ...
        <ul className={"footer__links"}>
          <li>
            <a href={"mailto:studio@ateliercairo.example"}>
{"studio@ateliercairo.example"}
            </a>
          </li>
          <li>
{"3 Zamalek St, Cairo"}
        ...
        <div className={"footer__links"}>
          <a aria-label={"whatsapp profile"} rel={"noopener noreferrer"} target={"_blank"} href={"https://wa.me/201000000015"}>
{"whatsapp"}
          </a>
        </div>
      </div>
...
{"Monday - Sunday: 10:00 AM - 10:00 PM"}
    ...
    <div className={"footer__bottom"}>
      <span>
{"© Atelier Cairo All rights reserved."}
      </span>
      <span>
